...
// shift a bit starting from the left (0b10000000, or 128) by that many places to get
...
constexpr byte HIGH_BIT = 0b10000000;
constexpr byte HAND_BIT = 0b00001000;
constexpr byte ROW_BITS = 0b00110000;
constexpr byte COL_BITS = 0b00000111;
